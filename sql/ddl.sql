...
CREATE TABLE `account` (
    ...
    `dr_amount` bigint(20)  NOT NULL DEFAULT 0 COMMENT '借方金额',
    `cr_amount` bigint(20)  NOT NULL DEFAULT 0 COMMENT '贷方金额',
...
CREATE TABLE `daily_bill` (
    ...
    `tx_amount` bigint(20)  NOT NULL DEFAULT 0 COMMENT '交易金额',
    `dr_amount` bigint(20)  NOT NULL DEFAULT 0 COMMENT '借方金额',
    `cr_amount` bigint(20)  NOT NULL DEFAULT 0 COMMENT '贷方金额',
